...
public class AccountController {
        ...
        @ApiResponses(@ApiResponse(responseCode = "200", description = "Account created successfully", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ViewAccountDto.class), examples = @ExampleObject(value = "{\"id\": \"1\","
                        +
                        "\"balance\": \"2000\"," +
                        "\"accountType\": \"STANDARD\"," +
